  ...
  return (
    ...
    >
      <Link href={`/project/${project.id}`}>
        <div className="glass rounded p-6 group cursor-pointer hover:border-white/20 transition-all relative overflow-hidden">
          {/* Brand Accent */}
          <div 
          ...
          <div className="flex items-start justify-between mb-4 relative z-10">
            <div className="flex items-center gap-3">
              <div 
                className="w-12 h-12 rounded flex items-center justify-center text-lg font-black"
                style={{ 
            ...
            <div className="w-8 h-8 rounded glass flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all">
