      ...
      <div className="flex-1 flex overflow-hidden">
          ...
          >
            ...
            {loading && (
              <div className="flex gap-4 max-w-[800px]">
                <div className="w-10 h-10 rounded-2xl bg-primary/20 flex items-center justify-center glass shrink-0">
        ...
        <aside className="w-80 border-l border-white/10 p-8 hidden xl:block bg-black/20">
          ...
          <div className="space-y-4">
            <Card className="glass border-white/5 p-4 hover:bg-white/5 transition-colors cursor-pointer">
